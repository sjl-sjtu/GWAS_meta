...
timestart <- Sys.time()
maxABF1 <- max(exh.abf(betas,ses,0.5,"indep",log=TRUE))
timeend <- Sys.time()
maxABFtime1 <- difftime(timeend,timestart,units="min")
print("maxABF1")
c(maxABF1,maxABFtime1)

timestart <- Sys.time()
maxABF2 <- max(exh.abf(betas,ses,0.5,"fixed",log=TRUE))
timeend <- Sys.time()
maxABFtime2 <- difftime(timeend,timestart,units="min")
print("maxABF2")
c(maxABF2,maxABFtime2)

timestart <- Sys.time()
maxABF3 <- max(exh.abf(betas,ses,0.5,"correlated",0.7,log=TRUE))
timeend <- Sys.time()
maxABFtime3 <- difftime(timeend,timestart,units="min")
print("maxABF3")
c(maxABF3,maxABFtime3)

timestart <- Sys.time()
maxABF4 <- max(exh.abf(betas,ses,0.5,"correlated",0.3,log=TRUE))
timeend <- Sys.time()
maxABFtime4 <- difftime(timeend,timestart,units="min")
print("maxABF4")
c(maxABF4,maxABFtime4)

timestart <- Sys.time()
maxABF5 <- max(exh.abf(betas,ses,0.8,"correlated",0.7,log=TRUE))
timeend <- Sys.time()
maxABFtime5 <- difftime(timeend,timestart,units="min")
print("maxABF5")
c(maxABF5,maxABFtime5)

repeats <- 10

timestart <- Sys.time()
mcmc1 <-replicate(repeats,mcmc.abf(betas,ses,0.5,"indep",NA,log=TRUE,n.iter=10000))
timeend <- Sys.time()
...
timestart <- Sys.time()
mcmc2 <-replicate(repeats,mcmc.abf(betas,ses,0.5,"fixed",NA,log=TRUE,n.iter=10000))
timeend <- Sys.time()
...
timestart <- Sys.time()
mcmc3 <-replicate(repeats,mcmc.abf(betas,ses,0.5,"correlated",0.7,log=TRUE,n.iter=10000))
timeend <- Sys.time()
...
timestart <- Sys.time()
mcmc4 <-replicate(repeats,mcmc.abf(betas,ses,0.5,"correlated",0.3,log=TRUE,n.iter=10000))
timeend <- Sys.time()
...
timestart <- Sys.time()
mcmc5 <-replicate(repeats,mcmc.abf(betas,ses,0.8,"correlated",0.7,log=TRUE,n.iter=10000))
timeend <- Sys.time()
...
timestart <- Sys.time()
shotgun1 <-replicate(repeats,shotgun.abf(betas,ses,0.5,"indep",NA,log=TRUE,n.iter=500,B=5))
timeend <- Sys.time()
...
timestart <- Sys.time()
shotgun2 <-replicate(repeats,shotgun.abf(betas,ses,0.5,"fixed",NA,log=TRUE,n.iter=500,B=5))
timeend <- Sys.time()
...
timestart <- Sys.time()
shotgun3 <-replicate(repeats,shotgun.abf(betas,ses,0.5,"correlated",0.7,log=TRUE,n.iter=500,B=5))
timeend <- Sys.time()
...
timestart <- Sys.time()
shotgun4 <-replicate(repeats,shotgun.abf(betas,ses,0.5,"correlated",0.3,log=TRUE,n.iter=500,B=5))
timeend <- Sys.time()
...
timestart <- Sys.time()
shotgun5 <-replicate(repeats,shotgun.abf(betas,ses,0.8,"correlated",0.7,log=TRUE,n.iter=500,B=5))
timeend <- Sys.time()
...
dfSim2<-data.frame(maxABF1=maxABF1,maxABF2=maxABF2,maxABF3=maxABF3,
                   maxABF4=maxABF4,maxABF5=maxABF5,maxABFtime1=maxABFtime1,
                   maxABFtime2=maxABFtime2,maxABFtime3=maxABFtime3,
                   maxABFtime4=maxABFtime4,maxABFtime5=maxABFtime5,
                   mcmcABFlist1=mcmcABFlist1,mcmcABFlist2=mcmcABFlist2,
                   mcmcABFlist3=mcmcABFlist3,mcmcABFlist4=mcmcABFlist4,
                   mcmcABFlist5=mcmcABFlist5,mcmcTimelist1=mcmcTimelist1,
                   mcmcTimelist2=mcmcTimelist2,mcmcTimelist3=mcmcTimelist3,
                   mcmcTimelist4=mcmcTimelist4,mcmcTimelist5=mcmcTimelist5,
                   shotgunABFlist1=shotgunABFlist1,shotgunABFlist2=shotgunABFlist2,
                   shotgunABFlist3=shotgunABFlist3,shotgunABFlist4=shotgunABFlist4,
                   shotgunABFlist5=shotgunABFlist5,shotgunTimelist1=shotgunTimelist1,
                   shotgunTimelist2=shotgunTimelist2,shotgunTimelist3=shotgunTimelist3,
                   shotgunTimelist4=shotgunTimelist4,shotgunTimelist5=shotgunTimelist5)
print("summary")
dfSim2
write.csv(dfSim2,file = "sim2.csv",na = "NA",row.names = FALSE)

datails <- rbind(mcmc1,mcmc2,mcmc3,mcmc4,mcmc5,shotgun1,shotgun2,shotgun3,shotgun4,shotgun5)
write.csv(datails,file = "sim2_detail.csv",na = "NA")